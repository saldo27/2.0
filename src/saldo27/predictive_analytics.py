...
class PredictiveAnalyticsEngine:
    ...
    def __init__(self, scheduler, config: dict[str, Any] = None):
        ...
        self.historical_data_manager = HistoricalDataManager(scheduler, storage_path=self.config["storage_path"])
    ...
    def _assess_forecast_risks(self, forecasts: dict[str, Any]) -> dict[str, Any]:
        ...
        risk_assessment = {"overall_risk_level": "low", "specific_risks": [], "risk_factors": {}}
    ...
    def _generate_resource_planning(self, forecasts: dict[str, Any]) -> dict[str, Any]:
        ...
        resource_planning = {"staffing_recommendations": [], "capacity_planning": {}, "optimization_opportunities": []}
    ...
    def _calculate_forecast_confidence(self, forecasts: dict[str, Any]) -> dict[str, Any]:
        ...
        confidence = {"overall_score": 0.5, "data_quality_score": 0.5, "model_agreement_score": 0.5, "factors": {}}
        ...
        try:
            ...
            confidence["overall_score"] = (
                confidence["data_quality_score"] * 0.6 + confidence["model_agreement_score"] * 0.4
            )
    ...
    def get_predictive_insights(self) -> dict[str, Any]:
        ...
        try:
            ...
            if self.latest_forecasts:
                ...
                insights["recommendations"].extend(self.latest_forecasts.get("recommendations", []))
            else:
                insights["recommendations"].append("Generate forecasts to get predictive insights")
            ...
            if historical_summary.get("status") == "data_available":
                ...
                if record_count > 0:
                    insights["key_insights"].append(f"Historical analysis based on {record_count} data records")
                else:
    ...
    def get_optimization_suggestions(self, current_schedule_data: dict[str, Any] = None) -> list[str]:
        ...
        try:
            ...
            historical_summary = self.historical_data_manager.get_historical_summary()
            if historical_summary.get("status") != "data_available":
                suggestions.append("Collect more historical data to improve prediction accuracy")
            elif historical_summary.get("record_count", 0) < 30:
                suggestions.append("Continue collecting data for more accurate long-term forecasts")
