...
class HistoricalDataManager:
    ...
    def collect_current_schedule_data(self) -> dict[str, Any]:
        ...
        try:
            ...
            raise SchedulerError(f"Failed to collect schedule data: {e!s}")
    ...
    def _calculate_worker_metrics_optimized(self, stats: dict[str, Any]) -> dict[str, Any]:
        ...
        worker_metrics = {"availability_patterns": {}, "workload_distribution": {}, "performance_indicators": {}}
    ...
    def _get_cached_coverage_result(self, cache_key: str) -> dict[str, Any] | None:
    ...
    def _calculate_coverage_metrics(self) -> dict[str, Any]:
        ...
        coverage_metrics = {"overall_coverage": 0.0, "post_coverage": {}, "time_gaps": [], "critical_gaps": []}
    ...
    def _get_cached_constraint_result(self, cache_key: str) -> dict[str, Any] | None:
    ...
    def _get_cached_seasonal_result(self, cache_key: str) -> dict[str, Any] | None:
    ...
    def _extract_seasonal_indicators(self) -> dict[str, Any]:
        ...
        seasonal_indicators["weekday_patterns"] = {str(i): count for i, count in enumerate(weekday_shifts)}
    ...
    def _get_cached_efficiency_result(self, cache_key: str) -> float | None:
    ...
    def _get_cached_post_rotation_result(self, cache_key: str) -> float | None:
    ...
    def _get_cached_monthly_variance_result(self, cache_key: str) -> float | None:
    ...
    def store_historical_data(self, data: dict[str, Any]) -> None:
        ...
        try:
            ...
            raise SchedulerError(f"Failed to store historical data: {e!s}")
        ...
        try:
            ...
            forecasting_data = {
                ...
                "constraint_violations": [
                    record["constraint_metrics"]["total_violations"] for record in recent_records
                ],
