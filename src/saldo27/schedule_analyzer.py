...
class CalendarFileProcessor:
    ...
    def detect_calendar_structure(self, text):
        ...
        return {"raw_lines": calendar_lines, "text_content": text}
...
class ScheduleAnalyzer:
    ...
    def __init__(self, start_date, calendar_text, name_mapping=None, holidays=None, shifts_per_day=4):
        ...
        logging.info(
            f"ScheduleAnalyzer: Total de {len(self.bridge_dates)} fechas de puente: {sorted(self.bridge_dates)}"
        )
    ...
    def parse_calendar(self):
        ...
        current_date = (
            date(self.start_date.year, self.start_date.month, 1)
            if hasattr(self.start_date, "year")
