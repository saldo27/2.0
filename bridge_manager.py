...
class BridgeManager:
    ...
    def detect_bridges(
        self, holidays: list[datetime], start_date: datetime, end_date: datetime
    ) -> list[dict[str, Any]]:
        """
        ...
        for holiday in holiday_dates:
            ...
            if bridge_info:
                ...
                if valid_bridge_days:
                    ...
                    logger.info(
                        f"Bridge detected: {holiday} ({bridge_info['weekday_name']}) - "
    ...
    def calculate_bridge_stats(
        self, worker_assignments: dict[str, list[datetime]], workers: dict[str, dict]
    ) -> dict[str, Any]:
        """
    ...
    def get_bridge_count_for_worker(self, worker_id: str, worker_assignments: dict[str, list[datetime]]) -> int:
        """
